...
//   let uniqSongList = uniqBy(data[key].songList, 'link')
//   console.log('uniqSongList.length_after', uniqSongList.length)
// }
// console.log('data', Object.keys(data))

const resultTest = require('./data/tests/result.json')

for (let typeName in resultTest) {
  console.log('typeName', typeName)
  for (let key in resultTest[typeName]) {
    console.log('----' + key, resultTest[typeName][key].length)
  }
}